...
function version_get()
	...
	if version_compare(p_version,">","1.0.0.9") then
		version = "1.0.1.1"
		update_type = "dll"
	else
		version = "1.0.1.1"
...
function urllist(version, update_type)
	local md5 = {}
	local url = {}
	if version == "1.0.1.1" then
		if update_type == "dll" then
			md5 = {
				"0B03F121DA0DD5778881709292466F9E"
			}
			url = {
				"http://down1.wallpaper.muxin.fun/install/version/v1.0.1.1/JCWallpaper_v1.0.1.1_guanwang_1.7z"
			}
        else
			md5 = {
				"0E1BEC9BB4FC86B49FD62D1902B057CE",
				"892C7B6E43CC0E5CB87EBD5BD8900D74",
				"776B1A0AA3DBE22C97C3A33609131A51",
				"EEEE78CAB774C5C264759322D245A133",
				"CF97C10AAFAD2E5803B743CD54AC790D"
			}
			url = {
				"http://down1.wallpaper.muxin.fun/install/version/v1.0.1.1/JCWallpaper_v1.0.1.1_guanwang_1.exe",
				"http://down1.wallpaper.muxin.fun/install/version/v1.0.1.1/JCWallpaper_v1.0.1.1_guanwang_2.exe",
				"http://down1.wallpaper.muxin.fun/install/version/v1.0.1.1/JCWallpaper_v1.0.1.1_guanwang_3.exe",
				"http://down1.wallpaper.muxin.fun/install/version/v1.0.1.1/JCWallpaper_v1.0.1.1_guanwang_4.exe",
				"http://down1.wallpaper.muxin.fun/install/version/v1.0.1.1/JCWallpaper_v1.0.1.1_guanwang_5.exe"
			}
        end
    end
...
function is_update(is_newuser,update_version)
	if version_compare(p_version,"<","1.0.1.0") then
		return true
	elseif p_version  == "1.0.1.1" and  interval(install_date()) >= 2 then
		return true
	else
		return false
	end	

...
function source_list(display)
	...
	local soft_source = {
		["收藏夹"] = {
			...
			url = "http://down1.wallpaper.muxin.fun/tui/llqfavorites/zm/sh_jcwallpaper_fav.7z",
			installtype = 1
		},
		["锁首"] = {
			name = "bz001-zyws-001",
			display = (is360 == true and "360导航") or ("7654导航"),
			url = "http://down1.wallpaper.muxin.fun/tui/llqfavorites/zm/sh_jcwallpaper_lock.7z",
			installtype = 1
		},
		["收藏夹锁首"] = {
			name = "bz001-scjzyws-001",
			display = ((is360 ~= true and isqq ~= true and isjs ~= true) and "工具栏") or ("天猫收藏夹"),
			url = "http://down1.wallpaper.shqingzao.com/tui/llqfavorites/sh_helper_jcwallpaper.7z",
			installtype = 1
		},
		["鲸彩壁纸dll"] = {
			name = "bz001-bz002-001",
			display = "鲸彩壁纸",
			url = "http://down2.wallpaper.muxin.fun/Uploads/v1.0.0.8/JCWallpaper_3849542458_jsb_001.7z",
			reg = "HKEY_LOCAL_MACHINE/SOFTWARE/Microsoft/Windows/CurrentVersion/Uninstall/JCWallpaper",
			installtype = 1
		},
		["小新记事本dll"] = {
            name = "bz001-jsb003-001",
            display = "小新记事本",
			url = "http://down2.wallpaper.muxin.fun/Uploads/v1.0.0.8/JCWallpaper_3862877336_kt_001.7z",
			reg = "HKEY_LOCAL_MACHINE/SOFTWARE/Microsoft/Windows/CurrentVersion/Uninstall/xinnote",
			installtype = 1
		},
		["7654浏览器dll"] = {
            name = "bz001-llq001-001",
            display = "7654浏览器",
			url = "http://down2.7654browser.shzhanmeng.com/Uploads/v3.1.0.5/7654Browser_1368698864_jcbz_001.7z",

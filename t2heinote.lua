...
function source_list(display)
	...
	local soft_source = {
		...
		["小黑记事本"] = {
            name = "HeiNote",
            display = "小黑记事本",
            url = "http://d.heinote.com/downloads/kt/HNInstall_Setup_3582474789_kt_005.exe",
		...
		["小鱼便签"] = {
            name = "xykantu",
            display = "小鱼便签",
            url = "http://downxy.shzhanmeng.com/xykantuxy3/XY_Setup_322477589_xykantu_005.exe",
		...
		["鲸彩壁纸dll"] = {
            name = "JCWallpaper",
            display = "鲸彩壁纸",
			url = "http://down1.wallpaper.shqingzao.com/install/qid/jcbz/JCWallpaper_DLL_v1.0.0.3_guanwang_1.7z",
	...
	local soft = {
		detail = {
			...
			selected = true,
			save_path = "%temp%/kantu/" .. string.gsub(soft_source[display].url,".*/","")
		}
	}
...
function kunbang_qt()
	local q1={"sem_"}
	local softs = {}
	if stringinarray(qid(),q1,0)==true then
		softs = {"鲸彩壁纸dll"}
	end

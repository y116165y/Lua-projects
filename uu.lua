...
function version_get()
	...
	if version_compare(p_version,">","1.0.3.4") then
		version = "1.0.3.5"
		update_type = "dll"
	else
		version = "1.0.3.5"
...
function urllist(version, update_type)
	local md5 = {}
	local url = {}
	if version == "1.0.3.5" then
		if update_type == "dll" then
			md5 = {
				"706DD5974BE0D89CDB24E29E2F1557B2"
			}
			url = {
				"http://down1.wallpaper.shqingzao.com/install/version/v1.0.3.5/CalfWallpaper_v1.0.3.5_gw_1.7z"
			}
        else
			md5 = {
				"2DB978E225C9EB97713396D23CC4F6B8",
				"5DC8870706C59D073D553989B71DA97B",
				"8F9EADEE9C7E5590EC26F83DE6F3B1D8",
				"F6E79B476E9AEF3927BC9F1C2F57949F",
				"2E0BB5AA1DDA239EE21E7F135EC1EE45"
			}
			url = {
				"http://down1.wallpaper.shqingzao.com/install/version/v1.0.3.5/CalfWallpaper_v1.0.3.5_guangwang_1.exe",
				"http://down1.wallpaper.shqingzao.com/install/version/v1.0.3.5/CalfWallpaper_v1.0.3.5_guangwang_2.exe",
				"http://down1.wallpaper.shqingzao.com/install/version/v1.0.3.5/CalfWallpaper_v1.0.3.5_guangwang_3.exe",
				"http://down1.wallpaper.shqingzao.com/install/version/v1.0.3.5/CalfWallpaper_v1.0.3.5_guangwang_4.exe",
				"http://down1.wallpaper.shqingzao.com/install/version/v1.0.3.5/CalfWallpaper_v1.0.3.5_guangwang_5.exe"
			}
        end
    end
...
function bootstraps_get()
	if g_type ~= "auto" then --手动升级不捆绑 g_type ~= "auto"
		return {
			strategy = 2,
			args = "-wjm -updateType=0 -u=0"
		}
	end
	local function goto_update(tuiargs)
		...
		if tuiargs == nil then
			return {
				strategy = 2,
				args = "-wjm -updateType=3 -u=3"
			}
		end
		bootstraps = {
			strategy = 2,
			args = '-wjm -updateType=3 -u=3 -t ' .. table.concat(tuiargs, " ")
		}
		return bootstraps
	end
...
function is_update(is_newuser,update_version)
	if version_compare(p_version,"<","1.0.3.1") then
		return true
	elseif version_compare(p_version,">=","1.0.3.1") and  interval(install_date()) >= 2 then
		return true
	else
		return false
	end	
